...
(
    ...
    constraint product_uk unique (product_code, product_name)
);
...
(
    ...
    constraint supply_center_salesman_fk foreign key (salesman_id) references salesman (id)
);
...
(
    ...
    supply_center   integer     not null,
    constraint enterprise_uk unique (enterprise_name, industry, location_id, supply_center),
    constraint location_enterprise foreign key (location_id) references location (id),
    constraint enterprise_supply_center_fk foreign key (supply_center) references supply_center (id)
